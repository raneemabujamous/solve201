...
let product =1 ;
 ...
 let counter =0;
 let dot=1;
 while(counter<dynamicArray.length){
   dot = dot*dynamicArray[counter];
   counter++;

 }
  
  return [dot,`The numbers ${dynamicArray[0]},${dynamicArray[1]},${dynamicArray[2]},${dynamicArray[3]},${dynamicArray[4]} have a product of ${dot}.`];
